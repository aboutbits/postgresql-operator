...
public class HasForeignDataWrapperPrivilege1 extends AbstractRoutine<Boolean> {
    ...
    public HasForeignDataWrapperPrivilege1() {
        super("has_foreign_data_wrapper_privilege", PgCatalog.PG_CATALOG, DSL.comment("user privilege on foreign data wrapper by user oid, foreign data wrapper oid"), SQLDataType.BOOLEAN);
     ...
     */
    public HasForeignDataWrapperPrivilege1 set__1(String value) {
        setValue(_1, value);
        return this;
    }
     ...
     */
    public HasForeignDataWrapperPrivilege1 set__1(Field<String> field) {
        setField(_1, field);
        return this;
    }
     ...
     */
    public HasForeignDataWrapperPrivilege1 set__2(String value) {
        setValue(_2, value);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public HasForeignDataWrapperPrivilege1 set__2(Field<String> field) {
        setField(_2, field);
        return this;
    }
     ...
     */
    public HasForeignDataWrapperPrivilege1 set__3(String value) {
        setValue(_3, value);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public HasForeignDataWrapperPrivilege1 set__3(Field<String> field) {
        setField(_3, field);
        return this;
    }
}
